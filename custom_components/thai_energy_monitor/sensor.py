...
class ThaiEnergyCostSensor(
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            ...
            "projected_monthly_solar_kwh": self.coordinator.data.get("projected_monthly_solar_kwh"),
            "projected_monthly_export_kwh": self.coordinator.data.get("projected_monthly_export_kwh"),
            "projected_monthly_self_consumption_kwh": self.coordinator.data.get("projected_monthly_self_consumption_kwh"),
            "projected_monthly_solar_savings_thb": self.coordinator.data.get("projected_monthly_solar_savings_thb"),
            "projected_monthly_solar_revenue_thb": self.coordinator.data.get("projected_monthly_solar_revenue_thb"),
            "projected_monthly_total_solar_benefit_thb": self.coordinator.data.get("projected_monthly_total_solar_benefit_thb"),
            "projected_bill_without_solar_thb": self.coordinator.data.get("projected_bill_without_solar_thb"),
            "projected_solar_bill_reduction_pct": self.coordinator.data.get("projected_solar_bill_reduction_pct"),
            "today_import_kwh": self.coordinator.data.get("today_import_kwh", 0.0),
            "today_solar_kwh": self.coordinator.data.get("today_solar_kwh", 0.0),
            "today_export_kwh": self.coordinator.data.get("today_export_kwh", 0.0),
            "today_solar_savings_thb": self.coordinator.data.get("today_solar_savings_thb", 0.0),
            ...
            "lookback_12_months_data": self.coordinator.data.get("lookback_12_months_data") if self.coordinator.data else getattr(self.coordinator, "lookback_12_months_data", None),
            "bess_12_months_data": self.coordinator.data.get("bess_12_months_data") if self.coordinator.data else getattr(self.coordinator, "bess_12_months_data", None),
            ...
            "bess_solar_sellback_active": self.coordinator.config_data.get("bess_solar_sellback_active", self.coordinator.config_data.get("enable_solar_sellback", True)),
            ...
            "enable_solar_sellback": self.coordinator.config_data.get("enable_solar_sellback", True),
