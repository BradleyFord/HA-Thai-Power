...
Solar Net Billing Riemann sums, BESS storage shift simulation, and MEA points conversion.
"""
...
class TestThaiEnergyMonitorCore(unittest.TestCase):
    ...
    def test_tariff_1_1_full_tier_progression(self) -> None:
        ...
        # Tier 1: 15 * 2.3488 = 35.232
        # Tier 2: 10 * 2.9882 = 29.882
        # Tier 3: 10 * 3.2405 = 32.405
        # Tier 4: 65 * 3.6237 = 235.5405
        # Tier 5: 50 * 3.7171 = 185.855
        # Tier 6: 250 * 4.2218 = 1055.45
        # Tier 7: 100 * 4.4217 = 442.17
        # Total Base Cost = 2016.5345
        base_cost = calculate_tiered_cost(consumption_kwh, TARIFF_1_1_TIERS)
    ...
    def test_tou_tariff_1_3_1_cost(self) -> None:
        ...
        # (100 * 5.1135) + (300 * 2.6037) = 511.35 + 781.11 = 1292.46
    ...
    def test_tou_tariff_1_3_2_cost(self) -> None:
        ...
        # (100 * 5.7982) + (300 * 2.6369) = 579.82 + 791.07 = 1370.89
    ...
    def test_statutory_vat_and_total_bill(self) -> None:
        ...
        import_kwh = 350.0
        ft_rate = DEFAULT_FT_RATE  # 0.395 THB/kWh
        base_cost = calculate_tiered_cost(import_kwh, TARIFF_1_2_TIERS)  # 1331.59
        service_charge = TARIFF_1_2_SERVICE_CHARGE  # 38.22
        ft_charge = import_kwh * ft_rate  # 138.25

        subtotal = base_cost + service_charge + ft_charge  # 1508.06
        vat_amount = subtotal * VAT_RATE  # 105.5642
        total_bill = subtotal + vat_amount  # 1613.6242
    ...
    def test_solar_net_billing_riemann_sum(self) -> None:
        ...
        marginal_rate = 4.2218  # Retail import rate during consumption window

        solar_savings = self_consumption_kwh * marginal_rate  # 506.616 THB
        solar_revenue = export_kwh * DEFAULT_SOLAR_SELLBACK  # 50 * 2.20 = 110.00 THB
        total_benefit = solar_savings + solar_revenue  # 616.616 THB
    ...
    def test_mea_points_cash_conversion(self) -> None:
        ...
        points = 1250
        cash_value = points * MEA_POINT_CASH_CONVERSION  # 125.00 THB
